...
/**
 * POST /api/staging/{id}/reject → orchestrator POST /orchestrator/staging/{id}/reject
 */
export async function POST(
  ...
  const url = `${base}/orchestrator/staging/${encodeURIComponent(stagingSnapshotId)}/reject`;
