...
/**
 * POST /api/staging/{id}/unapprove → orchestrator POST /orchestrator/staging/{id}/unapprove
 */
export async function POST(
  ...
  const url = `${base}/orchestrator/staging/${encodeURIComponent(stagingSnapshotId)}/unapprove`;
