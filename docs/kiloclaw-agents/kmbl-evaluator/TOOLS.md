...
- **In scope:** Read-only inspection, logs, test or browser checks, HTTP fetches to **preview_url** or URLs present in **build_candidate** when needed to verify criteria, and structured capture of evidence into **artifacts** / **metrics**.
